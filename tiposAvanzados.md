...
Considere que cuando se usan diccionarios es posible que una 
...
Para borrar valores y su respectiva llave se utiliza una
sintáxis similar:
```swift
books[5] = nil
...
Un ejemplo de una estructura llamada `Person` que contiene
